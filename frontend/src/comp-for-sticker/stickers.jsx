    ...
    <>
      ...
      {showTrash && (
        <div className="
          ...
          ">
            <div className={isDark ? "bg-gray-700 rounded-2xl w-full max-w-2xl max-h-[80vh] overflow-hidden shadow-2xl":"bg-white rounded-2xl w-full max-w-2xl max-h-[80vh] overflow-hidden shadow-2xl"}>
              <div className={isDark ? " flex items-center justify-between p-6 border-b bg-gradient-to-r from-red-950 to-pink-950":"flex items-center justify-between p-6 border-b bg-gradient-to-r from-red-50 to-pink-50"}>
            ...
            <div className={isDark ? "p-6 border-t bg-gray-700 flex justify-between items-center":"p-6 border-t bg-gray-50 flex justify-between items-center"}>
